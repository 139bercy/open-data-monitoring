...
def test_strip_volatile_fields_datagouv():
    ...
    snapshot = {
        ...
        "internal": {
            "created_at_internal": "2024-01-01T12:00:00Z",
            "last_modified_internal": "2024-01-01T12:00:00Z"
        },
        "resources": [
            {
                "id": "res1",
...
def test_hashing_stability():
    ...
    s1 = {
        ...
        "metrics": {
            "views": 100,
            "reuses_by_months": {"2024-01": 1}
        },
        "last_modified": "2024-01-01T12:00:00Z",
        "internal": {
            "last_modified_internal": "2024-01-01T12:00:00Z",
            "created_at_internal": "2020-01-01"
        },
    ...
    s2 = {
        ...
        "internal": {
            "last_modified_internal": "2024-01-02T12:00:00Z",
            "created_at_internal": "2020-01-01"
        },
