...
def test_postgresql_upsert_restores_and_updates_deleted_dataset(pg_app, pg_ods_platform, ods_dataset):
    ...
    new_data = {**ods_dataset, "metas": {**ods_dataset["metas"], "default": {**ods_dataset["metas"]["default"], "title": "Updated SQL Title"}}}
...
def test_postgresql_check_deletions_isolation_between_platforms(pg_app, pg_ods_platform, ods_dataset):
    ...
    # Create Platform B
    platform_b_data = {**platform_1, "name": "Platform B", "slug": "platform-b", "url": "http://platform-b.com", "type": "opendatasoft"}
