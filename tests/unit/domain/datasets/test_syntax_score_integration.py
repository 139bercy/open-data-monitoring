...
def test_dataset_add_quality_calculates_syntax_score():
    ...
    dataset.add_quality(
        downloads_count=10, api_calls_count=5, has_description=True, is_slug_valid=True, previous_raw=old_raw
    )
...
def test_dataset_add_quality_without_previous_raw():
    ...
    dataset.add_quality(downloads_count=10, api_calls_count=5, has_description=True, is_slug_valid=True)
