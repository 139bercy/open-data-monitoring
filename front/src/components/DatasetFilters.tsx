...
import type { DatasetListQuery, PlatformRef, PublishersRef } from "../types/datasets";
                ...
                <div className="fr-col-12 fr-col-md-4">
                    <Select
                        ...
                        nativeSelectProps={{
                            ...
                            onChange: (e: React.ChangeEvent<HTMLSelectElement>) => onChange({ platformId: e.currentTarget.value || undefined, page: 1 }),
                ...
                <div className="fr-col-12 fr-col-md-3">
                    <Input
                        ...
                        nativeInputProps={{
                            ...
                            onChange: (e: React.ChangeEvent<HTMLInputElement>) => onChange({ createdFrom: e.currentTarget.value || undefined, page: 1 })
                        }}
                    />
                </div>
                <div className="fr-col-12 fr-col-md-3">
                    <Input
                        ...
                        nativeInputProps={{
                            ...
                            onChange: (e: React.ChangeEvent<HTMLInputElement>) => onChange({ createdTo: e.currentTarget.value || undefined, page: 1 })
                        }}
                    />
                </div>
                <div className="fr-col-12 fr-col-md-3">
                    <Input
                        ...
                        nativeInputProps={{
                            ...
                            onChange: (e: React.ChangeEvent<HTMLInputElement>) => onChange({ modifiedFrom: e.currentTarget.value || undefined, page: 1 })
                        }}
                    />
                </div>
                <div className="fr-col-12 fr-col-md-3">
                    <Input
                        ...
                        nativeInputProps={{
                            ...
                            onChange: (e: React.ChangeEvent<HTMLInputElement>) => onChange({ modifiedTo: e.currentTarget.value || undefined, page: 1 })
                        }}
                    />
                </div>
